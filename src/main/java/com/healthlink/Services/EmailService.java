...
public class EmailService {
    ...
    public void sendWelcomeEmail(String toEmail, String password,String nom, String prenom) {
        final String fromEmail = "amenichakroun62@gmail.com"; // Ton email
        final String appPassword = "njgr etcs umzb najh"; // Mot de passe d'application Gmail
        ...
        try {
            ...
            String htmlContent = generateHtml(toEmail, password, nom, prenom);            message.setContent(htmlContent, "text/html; charset=utf-8");
    ...
    private String generateHtml(String email, String password, String nom, String prenom) {
        // Utilisez l'URL directe de l'image (avec l'extension .jpg/.png)
        String logoUrl = "https://i.imgur.com/RpVsOcX.png"; // Remplacez par votre URL directe
    ...
    public void sendApprovalEmail(String toEmail, String nom, String prenom) {
        final String fromEmail = "amenichakroun62@gmail.com";
        final String appPassword = "njgr etcs umzb najh";
